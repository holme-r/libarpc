 ...
 */
definition *
findval(list *lst, char *val, findfn_t cmp)
{
...
void
pvname_lookup(char *pname, char *vnum)
{
	f_print(fout, "%s_%s_lookup", locase(pname), vnum);
}
...
void
pvname_async(char *pname, char *vnum)
{
	f_print(fout, "%s_%s_async", locase(pname), vnum);
}

void
pvname_cb(char *pname, char *vnum)
{
	f_print(fout, "%s_%s_cb_t", locase(pname), vnum);
}
